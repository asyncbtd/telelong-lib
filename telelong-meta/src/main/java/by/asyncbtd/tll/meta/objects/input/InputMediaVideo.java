...
public class InputMediaVideo implements InputMedia {
    ...
    public InputMediaVideo(String media, InputFile thumbnail, String caption, String parseMode, List<MessageEntity> captionEntities, Boolean showCaptionAboveMedia,
                           Integer width, Integer height, Integer duration, Boolean supportsStreaming, Boolean hasSpoiler) {
        this.media = media;
        this.thumbnail = thumbnail;
        this.caption = caption;
        this.parseMode = parseMode;
